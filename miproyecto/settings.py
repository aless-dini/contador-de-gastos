...
SECRET_KEY = 'django-insecure-yq3anf_8ha3og9w=_dkp@sv#_ps&s9hi0beub=y&xhkmzth&3e'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'contador_de_gastos',
        'USER': 'root',
        'PASSWORD': 'Qeqe89qe',  # La que pusiste al instalar MySQL
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
